...
class GameWindow < Gosu::Window
  ...
  def initialize
    ...
    @background_image = Gosu::Image.new(self, "", true)
    
    # given a 'sprite' image, splits it into evenly-sized 'tiles'
    # based on given width, height
    # returns an array of Gosu::Image objects
    @star_anim = Gosu::Image::load_tiles(self, "/Users/ndeluca/Desktop/imgres-1.jpg", 25, 25, false)
    
    # Note that pure magenta color (0xffff00ff) in BMP files is 
    # rendered as transparent
    @ship_image =  Gosu::Image.new(self, '/Users/ndeluca/Desktop/imgres-3.jpg', false)
    
    
    @shield_image = Gosu::Image.new(self, '/Users/ndeluca/Desktop/imgres.jpg', false)
